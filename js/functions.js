...
function sayHello(name = "Michaela"){
    return `Hello ${name}`
}
...
let tipPercentage = prompt("What percent would you like to tip?");
alert("Your tip should be " + (totalBill * tipPercentage).toFixed(2));
